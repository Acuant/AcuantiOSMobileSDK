...
-(void)initUI{
    ...
    if(_facialData!=nil){
        resultStr = [[[[resultStr stringByAppendingString:@"Face Liveliness detected"] stringByAppendingString:_separator] stringByAppendingString:[NSString stringWithFormat:@"%d",_facialData.faceLivelinessDetection]] stringByAppendingString:@"\n"];
        resultStr = [[[[resultStr stringByAppendingString:@"Face Match Confidence Rating"] stringByAppendingString:_separator] stringByAppendingString:[NSString stringWithFormat:@"%d",_facialData.facialMatchConfidenceRating]] stringByAppendingString:@"\n"];
        
        resultStr = [[[[resultStr stringByAppendingString:@"Face Matched"] stringByAppendingString:_separator] stringByAppendingString:[NSString stringWithFormat:@"%d",_facialData.isMatch]] stringByAppendingString:@"\n"];
    }
    ...
    if(Result==Passed || Result==Failed || Result==Unknown){
        if(Result==Passed){
            resultStr =  [resultStr stringByAppendingString:[[[@"Authentication Result" stringByAppendingString:_separator] stringByAppendingString:@"Passed"] stringByAppendingString:@"\n"]];
        }else if(Result==Failed){
            resultStr =  [resultStr stringByAppendingString:[[[@"Authentication Result" stringByAppendingString:_separator] stringByAppendingString:@"Failed"] stringByAppendingString:@"\n"]];
        }else if(Result==Unknown){
            resultStr =  [resultStr stringByAppendingString:[[[@"Authentication Result" stringByAppendingString:_separator] stringByAppendingString:@"Unknown"] stringByAppendingString:@"\n"]];
        }
    }else{
