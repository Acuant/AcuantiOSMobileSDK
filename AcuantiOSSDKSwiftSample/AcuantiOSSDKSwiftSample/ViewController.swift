...
class ViewController: UIViewController ,AcuantMobileSDKControllerCapturingDelegate,AcuantMobileSDKControllerProcessingDelegate,AcuantFacialCaptureDelegate,RegionSelectionDelegate,ResultCancelDelegate{
    ...
    override func viewDidLoad() {
        ...
        instance = AcuantMobileSDKController.initAcuantMobileSDK(withLicenseKey: "XXXXXXXXXXX", andDelegate: self)
    ...
    func showSelfiCaptureInterface(){
        ...
        var message : NSMutableAttributedString = NSMutableAttributedString.init(string: "Get closer until Red Rectangle appears and Blink");
    ...
    @IBAction func processTapped(_ sender: Any) {
        ...
        if(errorMessage == ""){
            ...
            var options : AcuantCardProcessRequestOptions  = AcuantCardProcessRequestOptions.defaultRequestOptions(for: cardType);
