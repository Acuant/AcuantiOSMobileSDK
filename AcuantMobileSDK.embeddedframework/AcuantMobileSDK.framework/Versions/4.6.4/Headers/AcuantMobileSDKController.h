...
/**
 ...
 @discussion if this method is not implemented or UIDeviceOrientationUnknown is returned, we'll display a automatic orientation.
 */
...
/**
 Called to obtain the barcode button text for the second button displayed in the barcode alert.
 @return the barcode button text
 @discussion if this method is not implemented or nil is returned, we'll display a custom button text
 */
...
/**
 ...
 @discussion The recommended size to this images is 1012 width and relative height to the width.
 */
