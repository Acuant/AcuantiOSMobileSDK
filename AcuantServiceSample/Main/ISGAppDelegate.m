...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[ISGViewController alloc] initWithNibName:@"ISGViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[ISGViewController alloc] initWithNibName:@"ISGViewController_iPad" bundle:nil];
    }
